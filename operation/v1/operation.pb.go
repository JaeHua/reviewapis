...
func (*AuditAppealRequest) Descriptor() ([]byte, []int) {
	return file_api_operation_v1_operation_proto_rawDescGZIP(), []int{4}
}
...
func (*AuditAppealReply) Descriptor() ([]byte, []int) {
	return file_api_operation_v1_operation_proto_rawDescGZIP(), []int{5}
}
...
const file_api_operation_v1_operation_proto_rawDesc = "" +
	"\n" +
	" api/operation/v1/operation.proto\x12\x0fapi.business.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xd4\x01\n" +
	...
	"\bopReason\x18\x04 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x02\x18\x80\x02R\bopReason\x12!\n" +
	...
	"\xfaB\ar\x05\x10\x01\x18\x80\x02R\x06reason\x12$\n" +
	"\acontent\x18\x04 \x01(\tB\n" +
	"\xfaB\ar\x05\x10\x01\x18\x80\x04R\acontent\x12\x18\n" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID2\xf5\x01\n" +
	"\tOperation\x12s\n" +
	"\vAuditReview\x12#.api.business.v1.AuditReviewRequest\x1a!.api.business.v1.AuditReviewReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11o/v1/review/audit\x12s\n" +
	"\vAuditAppeal\x12#.api.business.v1.AuditAppealRequest\x1a!.api.business.v1.AuditAppealReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11o/v1/appeal/auditB2\n" +
...
var file_api_operation_v1_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_operation_v1_operation_proto_goTypes = []any{
	(*AuditReviewRequest)(nil),  // 0: api.business.v1.AuditReviewRequest
	(*AuditReviewReply)(nil),    // 1: api.business.v1.AuditReviewReply
	(*AppealReviewRequest)(nil), // 2: api.business.v1.AppealReviewRequest
	(*AppealReviewReply)(nil),   // 3: api.business.v1.AppealReviewReply
	(*AuditAppealRequest)(nil),  // 4: api.business.v1.AuditAppealRequest
	(*AuditAppealReply)(nil),    // 5: api.business.v1.AuditAppealReply
}
var file_api_operation_v1_operation_proto_depIdxs = []int32{
	0, // 0: api.business.v1.Operation.AuditReview:input_type -> api.business.v1.AuditReviewRequest
	4, // 1: api.business.v1.Operation.AuditAppeal:input_type -> api.business.v1.AuditAppealRequest
	1, // 2: api.business.v1.Operation.AuditReview:output_type -> api.business.v1.AuditReviewReply
	5, // 3: api.business.v1.Operation.AuditAppeal:output_type -> api.business.v1.AuditAppealReply
...
func file_api_operation_v1_operation_proto_init() {
	...
	file_api_operation_v1_operation_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
