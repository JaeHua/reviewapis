...
func (x *ListReviewByUserIDRequest) GetPageNumber() int32 {
	if x != nil {
		return x.PageNumber
	}
	return 0
...
func (x *ListReviewByUserIDReply) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
const file_review_v1_review_proto_rawDesc = "" +
	...
	"\xfaB\ar\x05\x10\b\x18\x80\x04R\acontent\x12\x18\n" +
	...
	"\x04data\x18\x01 \x01(\v2\x19.api.review.v1.ReviewInfoR\x04data\"\xc0\x02\n" +
	"\n" +
	"ReviewInfo\x12\x1a\n" +
	...
	"\x06status\x18\v \x01(\x05R\x06status\"\xd4\x01\n" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID\"\x8c\x01\n" +
	"\x19ListReviewByUserIDRequest\x12\x1f\n" +
	"\x06userID\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x06userID\x12'\n" +
	"\n" +
	"pageNumber\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02(\x01R\n" +
	"pageNumber\x12%\n" +
	"\bpageSize\x18\x03 \x01(\x05B\t\xfaB\x06\x1a\x04\x18d(\x01R\bpageSize\"^\n" +
	"\x17ListReviewByUserIDReply\x12-\n" +
	"\x04data\x18\x01 \x03(\v2\x19.api.review.v1.ReviewInfoR\x04data\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x05R\x05total2\xac\x06\n" +
	"\x06Review\x12k\n" +
...
var file_review_v1_review_proto_depIdxs = []int32{
	...
	4,  // 1: api.review.v1.ListReviewByUserIDReply.data:type_name -> api.review.v1.ReviewInfo
