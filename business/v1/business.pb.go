...
const file_api_business_v1_business_proto_rawDesc = "" +
	...
	"\bappealID\x18\x01 \x01(\x03R\bappealID2\xfc\x01\n" +
	"\bBusiness\x12w\n" +
	"\x0fReplyUserReview\x12#.api.business.v1.ReplyReviewRequest\x1a!.api.business.v1.ReplyReviewReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11b/v1/review/reply\x12w\n" +
...
var file_api_business_v1_business_proto_depIdxs = []int32{
	0, // 0: api.business.v1.Business.ReplyUserReview:input_type -> api.business.v1.ReplyReviewRequest
	2, // 1: api.business.v1.Business.AppealReview:input_type -> api.business.v1.AppealReviewRequest
	1, // 2: api.business.v1.Business.ReplyUserReview:output_type -> api.business.v1.ReplyReviewReply
